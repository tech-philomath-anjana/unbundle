...
- Rs 2,095.25 of orders that tie to no payment at all
- 115,632 records per second
- 22 of those findings were given a cause the agent stage verified against the records, covering Rs 1,14,258.08 of turnover, of which Rs 1,230.99 is money whose disposition the verdict decides, wait for a gateway to recover or escalate it

## What to look at

### SETTLEMENT_FAILED  (2 findings)

upi captured 2026-07-31 between 20:00 and 24:00. 2 payments on setl_00001, which failed.
...
- 4 credits. All listed settlements are processed with zero shortfall; none of the defined causes (gateway outage, bank transfer charge, rate‑card mismatch, settlement never sent, or settlement failed) apply.
